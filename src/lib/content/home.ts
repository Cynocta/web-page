...
const homeEs: HomeContent = {
    services: {
        ...
        listLabel: "Servicios de esta área",
        visuals: {
            channels: ["WhatsApp", "Web", "Instagram"],
            agent: "Agente IA",
            outcomes: ["Calificado", "Cita agendada", "A un asesor"],
            flow: ["Formulario", "n8n", "CRM", "Reporte"],
            flowCaption: "Cada paso se ejecuta solo y queda registrado.",
            browserUrl: "tunegocio.com",
            browserCta: "Agendar diagnóstico",
            browserToast: "Nueva consulta · hace 2 s",
            chartTitle: "Consultas y citas por día",
            chartDays: ["L", "M", "X", "J", "V", "S", "D"],
            chartLegend: ["Consultas", "Citas"],
        },
